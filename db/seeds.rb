...
more_cadets = [    {:cadetID => 0, :lastName =>'Nye', :firstName => 'Olivia', :email => 'onye@tulane.edu', :phoneNumber => '8477701060', :school => 'Tulane University', :position => 'Flight Commander', :course => 'POC', :gradYear => 2020 , :flight => 'Alpha', :username => 'onye', :password => 'password'},
    ...
    {:cadetID => 8, :lastName => 'Kurdia', :firstName => 'Anastasia', :email => 'akurdia@tulane.edu', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Professor', :course => 'POC', :gradYear => 2019 , :flight => 'Bravo', :username => 'akurdia', :password => 'pwd11'},    {:cadetID => 9, :lastName => 'MyLast', :firstName => 'myFirst', :email => 'myName@tulane.edu', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'GMC', :gradYear => 2022 , :flight => 'Bravo', :username => 'myName', :password => 'pwd'},
    ...
    {:cadetID => 15, :lastName => 'Dustin', :firstName => 'Saathoff', :email => 'dsaathoff@tulane.edu', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'GMC', :gradYear => 2022 , :flight => 'Alpha', :username => 'dsaathoff', :password => 'pwd11'},
    {:cadetID => 16, :lastName => 'Allyson', :firstName => 'Swindall', :email => 'aswindall@tulane.edu', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'GMC', :gradYear => 2022 , :flight => 'Bravo', :username => 'aswindall', :password => 'pwd11'},
    ...
    {:cadetID => 18, :lastName => 'Jessica', :firstName => 'Day', :email => 'jday@tulane.edu', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'GMC', :gradYear => 2022 , :flight => 'Bravo', :username => 'jday', :password => 'pwd11'},
    {:cadetID => 19, :lastName => 'Nicholas', :firstName => 'Miller', :email => 'nmiller@tulane.edu', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'GMC', :gradYear => 2022 , :flight => 'Alpha', :username => 'nmiller', :password => 'pwd11'},
